#pragma once
#include <stdint.h>
enum {WIFI_MODE_REPEATER=3,WIFI_AUTH_MODE_OPEN=0,WIFI_AUTH_MODE_WPA2_PSK=7,WIFI_ENCRYPT_TYPE_AES_ENABLED=3,WIFI_ENCRYPT_TYPE_WEP_DISABLED=1,WIFI_IOT_COMMAND_CONFIG_BANDWIDTH_20MHZ=0};
